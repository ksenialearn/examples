...
#divide into odd and even lists
def divide(dancerList):
    oddList= []
    evenList= []
    for l in range (0,len(dancerList)):
        if not dancerList[l]%2==0:
            oddList.append(dancerList[l])
        else:
            evenList.append(dancerList[l])
